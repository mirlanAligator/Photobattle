...
<?php if (!$this->noPermission) { ?>
    ...
    <div class="select-gender">
        <?php echo $this->htmlLink(array('action' => 'gender', 'g' => 3, 'a' => 'index'), $this->translate("Female"), array('class' => $this->gender == 3
                                                                                ? 'active' : "no-active")); ?>
        <?php echo $this->htmlLink(array('action' => 'gender', 'g' => 2, 'a' => 'index'), $this->translate("Male"), array('class' => $this->gender == 2
                                                                                ? 'active' : "no-active")); ?>
    </div>
...
<!--                <div class="won">--><?php //echo $this->translate('Won'); ?><!--: --><?php //echo $this->user1Score['win']; ?><!--</div>-->
...
<!--                <div class="won">--><?php //echo $this->translate('Won'); ?><!--: --><?php //echo $this->user2Score['win']; ?><!--</div>-->
<!--                <div class="lost">--><?php //echo $this->translate('Lost'); ?>
